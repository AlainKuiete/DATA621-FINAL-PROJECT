...
LABEL
  ...
  BATH_FAN = "USE AN EXHAUST FAN IN CHILD'S BATHROOM"
  BIRTHRF = "WHETHER BIRTH WEIGHT LESS THAN 5.5 POUNDS"
  BIRTHW1 = "BIRTH WEIGHT"
  CADJUST = "CHILD ASTHMA CALL-BACK ADJUST FACTOR"
  CAGEG_F1   = "CHILD ASTHMA CALL-BACK 1 AGE GROUPS"
  CAGEG_F2   = "CHILD ASTHMA CALL-BACK 2 AGE GROUPS"
  CAGEG_F3   = "CHILD ASTHMA CALL-BACK 3 AGE GROUPS"
  CAGEG_F4   = "CHILD ASTHMA CALL-BACK 4 AGE GROUPS"
  CAGEG_F2_M = "MODIFIED TWO CHILD ASTHMA CALL-BACK AGE GROUPS"
  CAGEG_F3_M = "MODIFIED THREE CHILD ASTHMA CALL-BACK AGE GROUPS"
  CAGEG_F3A  = "MODIFIED THREE/b CHILD ASTHMA CALL-BACK AGE GROUPS"
  ...
  CARPET = "CARPETING OR RUGS IN CHILD'S BEDROOM"
  CASTHDX2 = "EVER HAVE ASTHMA FROM BRFSS"
  CASTHNO2 = "STILL HAVE ASTHMA FROM BRFSS"
  CATTMPTS_F = "DISPOSITION CODES FOR CALL ATTEMPTS 1 THROUGH 20 ..."
  CLANDWT_F = "FINAL CHILD ASTHMA CALL-BACK WEIGHT"
  CLLCPWT_F = "CHILD ASTHMA FINAL WEIGHT"
  CLCWTV1_F = "CHILD ASTHMA FINAL WEIGHT VERSION 1"
  CLCWTV2_F = "CHILD ASTHMA FINAL WEIGHT VERSION 2"
  CLCWTV3_F = "CHILD ASTHMA FINAL WEIGHT VERSION 3"
  COMPASTH = "TYPICAL ATTACK"
  COOK_GAS = "GAS USED"
  CPOST = "CHILD ASTHMA CALL-BACK POST STRATIFICATION FACTOR"
  CRACEG_F = "CHILD RACE GROUP FOR ASTHMA CALL-BACK POST-STRATIFICATION"
  CSTATE   = "RESIDENTIAL STATE"
  CSTATE1  = "RESIDENTIAL STATE"
  CUR_ASTH = "STILL HAVE ASTHMA INCONSISTENT WITH BRFSS"
  CWEIGHT_IN = "INTERIM CHILD ASTHMA CALL-BACK WEIGHT"
  C_ROACH = "SAW COCKROACH INSIDE CHILD'S HOME PAST 30 DAYS"
  C_RODENT = "SAW MICE OR RATS INSIDE CHILD'S HOME PAST 30 DAYS"
  DAYCARE = "GO TO DAYCARE OUTSIDE HOME"
  DAYCARE1 = "WENT TO DAYCARE PAST 12 MONTHS"
  DCARE_ANML = "PETS IN DAYCARE"
  DCARE_APL = "WRITTEN ASTHMA ACTION PLAN IN DAYCARE"
  DCARE_MLD = "AWARE OF MOLD PROBLEM IN DAYCARE"
  DCARE_SMK = "SMOKING ALLOWED IN DAYCARE"
  ...
  INS_TYP = "TYPE OF INSURANCE COVERAGE"
  ...
  MISS_DCAR = "DAYS MISSED DAYCARE BECAUSE OF ASTHMA"
  MISS_SCHL = "HOW MANY DAYS MISSED SCHOOL"
  MKP_NAME = "ARE YOU SAMPLE PERSON"
  MKP_PERS = "MAY I SPEAK WITH PERSON"
  MKP_STATUS = "INTRODUCTION TO CORRECT RESPONDENT"
  MNTHDIFF = "CHILD AGE BY MONTH ON CALL-BACK INTERVIEW DAY"
  MOD_ENV = "EVER ADVISED CHANGE THINGS IN CHILD'S HOME"
  ...
  NEB_ID_8 = "NEB INTAL"
  NEB_ID_9 = "NEB IPRATROPRIUM BROMIDE"
  ...
  NO_SCHL = "REASON NOT IN SCHOOL NOW"
  ...
  RELATED = "RELATIONSHIP TO CHILD COMBINED BRFSS"
  RELATION = "RELATIONSHIP TO CHILD FROM QUESTION"
  REPEAT = "CHECK CORRECT PERSON ON PHONE"
  RSPSTATE = "RESPONDENT STATE"
  RSPSTAT1 = "RESPONDENT STATE"
  SCHGRADE = "WHAT GRADE WAS CHILD IN LAST TIME"
  SCHL_12 = "GONE TO SCHOOL OUTSIDE HOME PAST 12 MONTHS"
  SCH_ANML = "PETS IN CLASSROOM"
  SCH_APL = "WRITTEN ASTHMA ACTION PLAN IN SCHOOL"
  SCH_MED = "ASTHMA MEDICATION ALLOWED WITH CHILD IN SCHOOL"
  SCH_MOLD = "AWARE OF MOLD PROBLEM IN SCHOOL"
  SCH_STAT = "CURRENT GO TO SCHOOL OUTSIDE HOME"
  ...
  S_INSIDE = "ANYONE SMOKED INSIDE CHILD'S HOME"
  ...
  WEIGHT1 = "WEIGHT OF CHILD"
  WEIGHT2 = "WEIGHT OF CHILD  IN POUNDS"
  WOOD_STOVE = "FIREPLACE OR WOOD STOVE USED"
  _CIMPAGE = "IMPUTED CHILD AGE FOR ASTHMA CALL-BACK"
  ...
  MOSTKNOW   = "ARE YOU THE PARENT/GUARDIAN IN HOUSEHOLD WHO KNOW MOST ABOUT THE CHILD - BRFSS MKP"
  PRESENTALT = "IF PARENT/GUARDIAN REQUEST TO TRANSFER TO ANOTHER PERSON WHO IS MORE KNOWLEDGEABLE ABOUT THE CHILD - BRFSS MKP"
  KNOWMOST   = "ARE YOU THE PARENT/GUARDIAN IN HOUSEHOLD WHO KNOW MOST ABOUT THE CHILD - CALLBACK MKP"
  ALTPRESENT = "IF PARENT/GUARDIAN REQUEST TO TRANSFER TO ANOTHER PERSON WHO IS MORE KNOWLEDGEABLE ABOUT THE CHILD - CALLBACK MKP"
